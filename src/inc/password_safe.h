...
#define PWS_FLASH_START_PAGE    112
...
#define PWS_PASSWORD_START      (PWS_SLOTSTATE_LENGTH + PWS_SLOTNAME_LENGTH)    // 12
                                                                                // =
                                                                                // 1
                                                                                // +
                                                                                // 11
...
#define PWS_LOGINNAME_START     (PWS_SLOTSTATE_LENGTH + PWS_SLOTNAME_LENGTH + PWS_PASSWORD_LENGTH)  // 32
                                                                                                    // =
                                                                                                    // 1
                                                                                                    // +
                                                                                                    // 11
...
#define PWS_SLOT_LENGTH         (PWS_SLOTSTATE_LENGTH + PWS_SLOTNAME_LENGTH + PWS_PASSWORD_LENGTH + PWS_LOGINNAME_LENGTH)   // 64
                                                                                                                            // =
                                                                                                                            // 1
                                                                                                                            // +
                                                                                                                            // 11
